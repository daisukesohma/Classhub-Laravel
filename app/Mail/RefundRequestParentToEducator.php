...
class RefundRequestParentToEducator extends Mailable
{
    ...
    {
        return $this->subject('Refund request of Booking on Classhub')
            ->view('system-emails.refund-request-parent-educator')->sendgrid(['personalizations' => [],]);
    }
}
