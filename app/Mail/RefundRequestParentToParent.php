...
class RefundRequestParentToParent extends Mailable
{
    ...
    {
        return $this->subject('Your refund request on classhub')
            ->view('system-emails.refund-request-parent-parent')->sendgrid(['personalizations' => [],]);
    }
}
