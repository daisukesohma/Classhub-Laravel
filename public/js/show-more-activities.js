$(function() {
    $('ul.pagination').hide();
    $('.show-more-activities-container').jscroll({
        autoTrigger: false,
        ...
        padding: 0,
        debug: true,
        nextSelector: '.show-more-activities-button',
        contentSelector: 'div.show-more-activities-container',
        callback: function() {
            $('.show-more-activities-button-container').first().remove();
