...
@section('page_styles')
    ...
    @if($mobile)
        <style type="text/css">
            ...
            form#subject-booking-form .two-selectboxes {
                padding: 0 !important;
            }

            form#subject-booking-form div.mobile-no-padding {
                padding: 0 !important;
            }

            /*.modal-dialog{
                margin: -40px 10px 70px 10px !important;
            }*/
...
@section('content')
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <!--Begin:: App Aside-->
                <div class="row col-12 inbox" style="margin-top: 20px">
                    ...
                    <div class="col-md-4" id="{{ $mobile ?  'mobile-chat-users' : 'desktop-chat-users' }}">
                    ...
                    <div class="col-md-8" id="{{ $mobile ?  'mobile-chat-messages' : 'desktop-chat-messages' }}">
                                ...
                                <div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                                    <div class="kt-portlet__head">
                                        <div class="kt-chat__head ">
                                            ...
                                            <div class="kt-chat__center">
                                                ...
                                                <div class="message-tutorial-popup">
                                                    <span class="info-badge m-l-14" data-toggle="modal"
                                                          data-target="#inbox-first-visit-modal">i</span>
                                                </div>

                                            </div>
                                            @if($mobile)
                                                <div class="kt-chat__right mobile-only">
                                    ...
                                    @else
                                        <div class="kt-portlet__foot desktop-only">
                                            <div class="kt-chat__input">
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-6 d-flex justify-content-between">
                                                        <div class="kt_chat__actions attachment-container">
                                                            <label for="file-input">
                                                                <i class="fa fa-paperclip" style="color: #E74B65"></i>
                                                            </label>
    ...
    @include('educator.modals.schedule-free-call')
    ...
    @include('common.inbox-first-view-modal')
...
@section('page_scripts')
    ...
    @if($popup)
        <script type="text/javascript">
            $(function () {
                $('div#inbox-first-visit-modal').modal('show')
            })
        </script>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', 'a.schedule-free-call', function () {
            $('input#educator-id').val($(this).data('educator-id'))
            $('input#parent-id').val($(this).data('parent-id'))
        })


        $('body').on('click', 'a.schedule-free-call-btn', function () {
            $(resultModal).modal('show')
            $.ajax({
                type: 'POST',
                url: '{{ route('schedule.free.call') }}',
                data: {
                    _token: '{{ csrf_token() }}',
                    call_time: $('input#free-call-time').val(),
                    educator_id: $('input#educator-id').val(),
                    parent_id: $('input#parent-id').val(),
                },
                dataType: 'json',
