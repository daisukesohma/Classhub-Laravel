...
<div class="modal fade c-modal v1 cancel-class pause-class" id="opt-confirm-modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-body text-center p-r-35 p-l-35 p-t-0 p-b-15">
                ...
                <div class="two-buttons p-b-25">
                    <div class="row">
                        ...
                        <div class="col-6 text-center">
                            <a class="btn btn-sm btn-primary v2 shadow-v4 intercom-opt" href="javascript:void(0);"
