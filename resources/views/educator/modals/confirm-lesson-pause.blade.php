...
<div class="modal fade c-modal v1 cancel-class pause-class" id="pause-class-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-r-35 p-l-35 p-t-0 p-b-15">
                ...
                <div class="p-t-7">Do you really want to pause this class?</div>
                ...
                <div class="two-buttons p-b-25">
                    <div class="row">
                        ...
                        <div class="col-6 text-center">
                            <a class="btn btn-sm btn-primary v2 shadow-v4 pause-class-btn" href="javascript:void(0);"
