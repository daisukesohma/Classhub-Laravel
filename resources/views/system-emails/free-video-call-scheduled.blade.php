                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">Hi
                                                                {{ $user->name }},</h2>
                                                            <h3 style="font-family:Open Sans, Arial, sans-serif;">You
                                                                have scheduled a free video call session.</h3>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                Your free video call session is with:
                                                                <strong>{{ $with->name }}</strong>.<br>
                                                                Date Scheduled:
                                                                <strong>{{ \Carbon\Carbon::parse($videoCall->call_time)->format('l jS F Y') }}</strong>.<br>
                                                                Time Scheduled:
                                                                <strong>{{ \Carbon\Carbon::parse($videoCall->call_time)->format('h:i A') }}</strong>.<br>
                                                                <br>
                                                                <strong>
                                                                    We’ll send you another reminder email 5 minutes
                                                                    before your class is due to begin and you’ll be able
                                                                    to join the online room for your call then.
                                                                </strong>
                                                                <br>
                                                                <br>
                                                                <strong>Please note: that our online video tuition
                                                                    feature works on desktop computers and laptops only.
                                                                    It does not currently work on tablets or mobile
                                                                    devices.
                                                                </strong>
                                                            </p>
                                            ...
                                            <tr>
                                                ...
                                                <td width="550" align="center" style="padding-top:30px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%; display: inline-block; width: 45%;">
                                                                Have a great day,<br>
                                                                The ClassHub Team.
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
                                                ...
                                                <td width="" align="center" style="padding-top:0px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='center'>
                                                            <a href="#" style="margin: 1em 2.6em 3em 2.6em; color:#555; font-family:Open Sans, Arial, sans-serif;
