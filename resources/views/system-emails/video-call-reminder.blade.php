                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">Hi
                                                                {{ $toName }},</h2>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; line-height:150%;">
                                                                Your
                                                                online tuition session begins
                                                                in 5 minutes.</h2>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                Your online tuition session is with:
                                                                <strong>{{ $withName }}</strong>.<br>
                                                                Date Scheduled:
                                                                ...
                                                                <br>
                                                                <strong>
                                                                    Click the link below (‘Join Your Lesson’) to be taken straight into your Zoom lesson.
                                                                </strong>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 10px; text-align: center;">
                                                                ...
                                                                <div class="pink-button"><a
                                                                        @if ($meetingLink)
                                                                            href="{{ $meetingLink }}"
                                                                        @else
                                                                            href="{{ route('page.video-call', $classId) }}"
                                                                        @endif
                                                                        target="_blank"
