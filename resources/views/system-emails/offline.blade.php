...
<head>
    ...
    <title>Your profile is now offline.</title>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            ...
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">Your
                                                                profile is now offline.</h2>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                Your profile and classes are now hidden from all
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 10px; text-align: center;">
                                                                ...
                                                                <div class="pink-button"><a
                                                                        ...
                                                                        target="_blank"
                                                                        style="display: inline-block; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65; border-radius: 10px; box-sizing:border-box; cursor: pointer; text-decoration: none; font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0; padding-top: 15px; padding-bottom:15px;">Go
                                                                        Back Online</a>
