                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">Hi
                                                                {{ $user->name }},</h2>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">You
                                                                have scheduled an online tuition session.</h2>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                Your online tuition session is with:
                                                                <strong>{{ $with->name }}</strong>.<br>
                                                                Date Scheduled:
                                                                <strong>{{ \Carbon\Carbon::parse($videoCall->video_call_time)->format('l jS F Y') }}</strong>.<br>
                                                                Time Scheduled:
                                                                <strong>{{ \Carbon\Carbon::parse($videoCall->video_call_time)->format('h:i A') }}</strong>.<br>
                                                                <br><br>
                                                                Have a great day,<br>
                                                                The Classhub Team.
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" align="center"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 10px; text-align: center;">
                                                                ...
                                                                <div class="pink-button"><a href="{{ $link }}"
                                                                                            target="_blank"
                                                                                            style="display: inline-block; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65; border-radius: 10px; box-sizing:border-box; cursor: pointer; text-decoration: none; font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0; padding-top: 15px; padding-bottom:15px;">Join Online Session
                                                                    </a>
