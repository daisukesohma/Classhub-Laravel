...
<head>
    ...
    <title>You have an unfinished class</title>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            ...
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">You
                                                                have an unfinished class.</h2>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                You can’t take bookings without finishing your classes
                                                                setup. Please log in below and finish your
                                                                setup to begin accepting bookings.
                                                                <br><br>
                                                                Have a great day,<br>
                                                                The Classhub Team.
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 10px; text-align: center;">
                                                                ...
                                                                <div class="pink-button"><a
                                                                        href="{{ route('educator.lesson.edit', $lesson->id) }}"
                                                                        target="_blank"
                                                                        style="display: inline-block; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65; border-radius: 10px; box-sizing:border-box; cursor: pointer; text-decoration: none; font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0; padding-top: 15px; padding-bottom:15px;">Finish
                                                                        Class Setup</a>
                                            ...
                                            <tr>
                                                ...
                                                <td width="" align="center" style="padding-top:0px;">
													...
													font-size:14px; line-height:25px; text-align:center">
                                                                Need help finishing your class?
                                                            </a>
                                                            <br><br>
                                                            {{--<span
