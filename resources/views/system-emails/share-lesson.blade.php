                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
                                                ...
                                                <td width="400" valign="top" align="left">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left" ;
                                                            ...
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; color:#fff; font-weight:600;">
                                                                Hi,
                                                            </h2>
                                                            <h3 style="font-family:Open Sans, Arial, sans-serif; color:#fff; font-weight:400;">
                                                                Check out {{ $educator->firstname }} {{ $lesson->name }} on
                                                                Classhub.</h3>
                                                        </div>
                                                ...
                                                <td width="200" valign="top" align="center">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align='center' style="background:url('{{ url($photoUrl) }}'); background-size: cover; background-repeat: no-repeat; border-radius: 60px; width: 120px; height: 120px;
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
                                                ...
                                                <td width="620" valign="top" align="left">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left" style="background: url('{{ url($lessonImageUrl)}}'); background-size: cover; background-repeat: no-repeat; width: 620px; height: 213px;
                                                        background-position: center; ">
                                    ...
                                    <div class='movableContent'>
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; font-weight:600; line-height:140%; text-align:center;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 100px; text-align: center;">
                                                                ...
                                                                <div class="pink-button"><a href="{{ $lessonUrl }}" target="_blank"
                                                                                            style="display: inline-block; width:500px; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65; border-radius: 100px; box-sizing:border-box; cursor: pointer; text-decoration: none; font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0; padding-top: 15px; padding-bottom:15px;">BOOK
                                                                        NOW</a>
