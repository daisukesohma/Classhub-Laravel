                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
                                                ...
                                                <td width="620" valign="top" align="left">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left"
                                                             style="background:url('{{ url($lessonImageUrl) }}'); width: 620px; height: 213px; background-size: cover; background-repeat: no-repeat;">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                A kind reminder for {{ $educator->firstname }}
                                                                ’s {{ $lesson->name }} Class:
                                                                <br>
                                                                <strong><i>When your ClassHub lesson is about to start, you will receive a pop-up message, asking you to join the lesson.  Simply click ‘Join’ and you’ll be taken straight to your Zoom call.</i></strong>
                                                                <br>
                                                    ...
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="center" ;
                                                            ...
                                                            <p style="font-family:Open Sans, Arial, sans-serif; color:#555555; font-weight:600;">
                                                                {{ $educator->firstname }}’s {{ $lesson->name }} Class
                                                            </p>
                                    ...
                                    <div class='movableContent'>
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
                                                ...
                                                <td width="20">&nbsp;</td>
                                            </tr><!--End MANAGE BOOKING button-->

                                            <tr>
                                                <td width="10">&nbsp;</td>
                                                <td width="600" align="center" style="padding-top:20px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                            ...
                                            <tr>
                                                ...
                                                <td width="550" align="center" style="padding-bottom:px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            ...
                                                            <p style="margin: 1em 1em; color:#555; font-family:Open Sans, Arial, sans-serif;
					                  		font-size:11px; padding-left:5px; line-height:140%;">
                                                                ...
                                                                @if($toUser->educator)
                                                                    <a href="{{ route('page.help') }}#tutors"
                                                                       target='_blank'
                                                                       style="text-decoration:none; color: #E74B65;">{{ route('page.help') }}
                                                                        #tutors</a>
                                                                @else
                                                                    <a href="{{ route('page.help') }}#parents"
                                                                       target='_blank'
                                                                       style="text-decoration:none; color: #E74B65;">{{ route('page.help') }}
                                                                        #parents</a>
                                                                @endif
