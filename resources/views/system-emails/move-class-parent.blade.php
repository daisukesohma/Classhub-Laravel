...
<head>
    ...
    <title>Your class has been moved</title>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            ...
                                                            <p style="font-family:Open Sans, Arial, sans-serif;">
                                                                Your booking has been rescheduled. We have updated this in your bookings area.
                                                            </p>
                                                            <p style="color:#555; font-family:Open Sans, Arial, sans-serif;
															font-size:14px; line-height:150%;">
                                                                Tutor: {{ $educator->name }}.<br>
                                                                Class: {{ $lesson->name }}.<br>
                                                                Original
                                                                Date: {{ \Carbon\Carbon::parse($oldClass->date)->format('dS F Y') }}
                                                                {{ \Carbon\Carbon::parse($oldClass->start_time)->format('h:iA') }}
                                                                .<br>
                                                                New Date:
                                                                <strong>{{ \Carbon\Carbon::parse($newClass->date)->format('dS F Y') }}
                                                                    {{ \Carbon\Carbon::parse($newClass->start_time)->format('h:iA') }}</strong><br>
                                                                <br><br>
                                                                Have a great day,<br>
                                                                The Classhub Team.
                                                            </p>
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 10px; text-align: center;">
                                                                ...
                                                                <div class="pink-button">
                                                                    <a href="{{ route('parent.inbox') }}"
                                                                       target="_blank"
                                                                       style="display: inline-block; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65; border-radius: 10px; box-sizing:border-box; cursor: pointer; text-decoration: none; font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0; padding-top: 15px; padding-bottom:15px;">Message
                                                                        Tutor
                                                                    </a>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="620"
                                            ...
                                            <tr>
                                                ...
                                                <td width="" align="center" style="padding-top:0px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='center'>
                                                            <a href="{{ route('parent.dashboard') }}" style="margin: 1em 2.6em 3em 2.6em; color:#555; font-family:Open Sans, Arial, sans-serif;
													font-size:14px; line-height:25px; text-align:center">
                                                                Can't do the new date? You can cancel your class here.
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td width="" align="center" style="padding-top:0px;">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='center'>
                                                            ...
                                                            <a target="_blank"
                                                               href="{{ route('page.unsubscribe', base64_encode($parent->email)) }}"
