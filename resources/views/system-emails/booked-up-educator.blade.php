                                                    ...
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left">
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; color:#fff; font-weight:600; padding-left:px; line-height:100%;">
                                                                Your class can't take any more bookings.
                                                            </h2>
                                                        </div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                <br/>
                                                                <br/>
                                                                Start earning money by setting your class "{{ $lesson->name }}" live again or
                                                                listing a new class. It will only take a few minutes.
                                                                Click here
                                                                <br>
                                                            @if($class)
                                                                <h5 style="margin: 1em; line-height: 16px; color:#555; font-family:Open Sans, Arial, sans-serif">
                                                                    Class: {{ $class->day }}
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:25px;">
                                                                To view this class, please visit your dashboard:
                                                            </p>
