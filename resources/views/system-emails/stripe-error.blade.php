                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                Hi {{ $personDetails['name'] }},
                                                                <br/>
                                                                <br/>
                                                                Unfortunately we were unable to verify some of your documents / information you recently uploaded on to Classhub.
                                                                <br>
                                                                Please login to Classhub again and try updating your documents. To do this, please click on the button below.
                                                                <br>
                                                                <br>
                                                                To update these please click on the link below
                                                            </p>
