                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align="left">
                                                            <p style="margin:1em 2em;color:#555;font-family:'Open Sans', Arial, sans-serif;font-size:14px;line-height:25px;">
                                                                ...
                                                                <br>
                                                                <br>
                                                                Your Classhub account settings have been updated
                                                                successfully.
                                                                <br>
                                                                <br>
                                                                If you didn’t make these changes please <a
                                                                    href="mailto:support@classhub.ie"
                                                                    style="text-decoration:none;color:#E74B65;">contact
                                                                    support</a> immediately.
                                                                <br>
                                                                <br>
                                                                Thanks,<br>
                                                                The Classhub Team
                                                ...
                                                <td width="550" align="center">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align="left">
                                                            ...
                                                            <p style="margin:1em 2em;color:#555;font-family:'Open Sans', Arial, sans-serif;font-size:11px;padding-left:5px;line-height:25px;">
                                                                <span>If you need help with anything please don’t hesitate to <a
                                                                        href="mailto:support@classhub.ie"
                                                                        style="text-decoration:none;color:#E74B65;">contact us</a> or visit our <a
                                                                        href="{{ route('page.help') }}" target="_blank"
                                                                        style="text-decoration:none;color:#E74B65;">help</a></span>
                                                                page.
                                                            </p>
