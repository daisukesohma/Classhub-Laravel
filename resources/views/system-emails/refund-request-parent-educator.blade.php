                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                for {{ $educator->firstname }}’s {{ $lesson->name }}
                                                                Class.
                                                                <br>
                                                                <br>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:12px; line-height:20px;">
                                                                ...
                                                                The class has been booked and paid for
                                                                on {{ \Carbon\Carbon::parse($booking->created_at)->format('l, M d, Y H:i') }}
                                                                {{ \Carbon\Carbon::parse($booking->created_at)->format('l, M d, Y H:i') }}
                                                                <br>
                                                                Booking
                                                                ...
                                                                <a href="{{ route('educator.dashboard') }}"
                                                                   target='_blank'
                                                                   style="text-decoration:none; color: #E74B65;">
                                                                    View booking</a>
                                                            </p>
                                            ...
                                            <!-- end BOOKING CODE section-->
                                            <!--Start SEE REQUEST button-->
                                            <tr>
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:25px;">
                                                                The refund policy states that you have 72 hours to solve
                                                                the request. For more information on cancellation and
                                                                refund please see
