                                                    ...
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left">
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; color:#fff; font-weight:600; padding-left:px; line-height:100%;">
                                                                Just a reminder that your class starts shortly.
                                                            </h2>
                                                        </div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                <br/>
                                                                <br/>
                                                                Just a short note to remind you to be ready for your
                                                                class ,“{{ $lesson->name }}
                                                                from {{ $educator->firstname }}”.<br/><br/>
                                                                We’ll send you another reminder email 5 minutes before
                                                                your class is due to begin.
                                                                <br>
                                                                <strong><i>Please note: that
                                                                        our online video tuition feature works on
                                                                        desktop computers and laptops only. It does not
                                                                        currently work on tablets or mobile devices.</i></strong>
                                                                <br>
                                                                <br>
