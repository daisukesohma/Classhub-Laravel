...
<head>
    ...
    <title>New booking - email for teacher</title>
                                                        ...
                                                        <div class="contentEditable" align="left">
                                                            ...
                                                            <h5 style="font-family:Open Sans, Arial, sans-serif; color:#ffffff!important; font-weight:400;">
                                                                @if($lesson->type === 'pre_recorded')
                                                                    Your pre-recorded video has been purchased.
                                                                @else
                                                            ...
                                                            <p style="color:#ffffff!important; font-family:Open Sans, Arial, sans-serif;
					                  		font-size:14px;">
                                                                Booking
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @foreach($classes as $class)
                                                                        {{  \Carbon\Carbon::parse($class->date)->format('l, F d, Y') }}
                                                                        -
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:25px;">
                                                                Visit your ClassHub dashboard to manage your classes,
                                                                subjects and pre-recorded videos. You can also check up
                                                                on any upcoming and completed payouts in your
                                                                transaction history.
                                                                <br><br>
                                                            </p>
                                                        </div>
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px;line-height:140%;">
                                                            ...
                                                            <p style="margin: 1em 2em; color:#555; font-family:Open Sans, Arial, sans-serif; font-size:14px; padding-left:5px; line-height:140%;">
                                                                <a style="color: #E74B65;" href="{{ route('page.online-tuition') }}">Learn more
                                                                    about how online tution works on ClassHub</a>
                                                            </p>
                                                            <br>
