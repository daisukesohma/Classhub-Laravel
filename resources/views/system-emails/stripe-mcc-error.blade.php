                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                <br/>
                                                                <br/>
                                                                We need you to update Industry/MCC
                                                                of {{ $personDetails['name'] }}
                                                                (Stripe account email : {{ $personDetails['email'] }})
                                                                for our payment partners Stripe.
                                                                <br>
                                                                <strong>Note: IGNORE this email if you're already
                                                                    done</strong>
                                                                <br>
                                                                <br>
                                                                To update industry these please click on the link below
                                                            </p>
