...
<head>
    ...
    <title>Cancel class by parent - email for parent</title>
                                                ...
                                                <td width="600" valign="top" align="left">
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left">
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; color:#ffffff; font-weight:600; padding-left:px; line-height:100%;">
                                                                {{ $parent->firstname }}’s booking has been cancelled.
                                                            </h2>
                                                            <h5 style="font-family:Open Sans, Arial, sans-serif; color:#ffffff!important; font-weight:400;">
                                                                We are sorry to see your booking go.</h5>
                                                        </div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                ...
                                                                cancelled. You can message the user here.
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:25px;">
                                                                For more information on this please contact the parent
                                                                directly:
                                                            ...
                                                            <td style="font-family:Open Sans, Arial, sans-serif; font-size: 18px; vertical-align: top; background-color: #E74B65; border-radius: 100px; text-align: center;">
                                                                ...
                                                                <div class="pink-button">
                                                                    <a href="{{ route('educator.dashboard') }}"
                                                                       target="_blank"
                                                                       style="display: inline-block; width:500px; height:px; color: #ffffff; background-color: #E74B65; border: solid 1px #E74B65;
                                                                        border-radius: 100px; box-sizing:border-box; cursor: pointer; text-decoration: none;
                                                                        font-family:Open Sans, Arial, sans-serif; font-size: 18px; font-weight: 600; margin:0;
                                                                         padding-top: 15px; padding-bottom:15px">MESSAGE
                                                                        USER</a>
                                                                </div>
                                                            </td>
                                                        </tr>
