...
<head>
    ...
    <title>Online Tutition Reminder</title>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align='left'>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif;">Hi
                                                                {{ $user->name }},</h2>
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; line-height:150%;">Your
                                                                free video call session begins
                                                                in 5 minutes.</h2>
                                                                ...
                                                                <div class="pink-button">
                                                                    <a
                                                                        @if ($videoCall->meeting_link)
                                                                            href="{{ $videoCall->meeting_link }}"
                                                                        @else
                                                                            href="{{ route('page.free-video-call', $videoCall->id) }}"
                                                                        @endif
                                                                        target="_blank"
