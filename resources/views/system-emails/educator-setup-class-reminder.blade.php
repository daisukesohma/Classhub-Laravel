...
<head>
    ...
    <title>Set Up Class reminder</title>
                                                    ...
                                                    <div class="contentEditableContainer contentImageEditable">
                                                        <div class="contentEditable" align="left">
                                                            <h2 style="font-family:Open Sans, Arial, sans-serif; color:#fff; font-weight:600; padding-left:px; line-height:100%;">
                                                                Just a reminder, you still need to set up a class!
                                                            </h2>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:14px; line-height:140%;">
                                                                Hey {{ $educator->firstname }},
                                                                <br/>
                                                                <br/>
                                                                Setting up a class on classhub is easy! Start earning
                                                                money now. it will only take you a few minutes.
                                                                You can click <a
                                                                    href="{{ route('educator.lesson.create') }}">here</a>
                                                                to begin.
                                                                <br>
                                                                <br>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="600"
                                            ...
                                            <tr>
					                  		...
					                  		font-size:11px; padding-left:5px; line-height:140%;">
                                                                ...
                                                                For information on bookings and earning with Classhub,
                                                                please see

                                                                <a href="{{ route('page.terms-conditions') }}#fees"
                                                                   target='_blank'
                                                                   style="text-decoration:none; color: #E74B65;">Terms &
                                                                    Conditions</a> or visit our <a
