                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="{{ route('home') }}" class="m-brand__logo-wrapper">
                            ...
                            <img alt="" class="only-mobile not-scrolled" src="{{ asset('classhub-logo-light.png') }}" height="35px"/>
                            <img alt="" class="only-mobile scrolled-logo" src="{{ asset('classhub-logo.png') }}" height="35px"/>
                        </a>
                    </div>
