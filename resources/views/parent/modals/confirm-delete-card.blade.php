...
<div class="modal fade c-modal v1 cancel-class" id="confirm-delete-card-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-r-35 p-l-35 p-t-0 p-b-15">
                ...
                <p style="margin-top: 30px">Confirm delete this Card?</p>
                ...
                <div class="two-buttons p-b-25">
                    <div class="row">
                        ...
                        <div class=" text-center" style="float: right">
                            <a class="btn btn-sm btn-primary v2 shadow-v4 delete-card-btn" href="javascript:void(0);"
