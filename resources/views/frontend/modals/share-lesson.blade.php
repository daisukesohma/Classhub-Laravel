<div class="modal fade c-modal overlay-share-this" id="share-lesson-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group p-t-0">
                                ...
                                <input type="email" class="form-control" id="share-email" name="email">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-right" style="padding-top: 20px;">
                                <button type="button" class="btn btn-sm btn-primary shadow-v3 share-lesson-btn"
                ...
                .'&link='.urlencode(route('page.lesson', $lesson->slug)) }}">Messenger</a>
                                </li>
                                <li><a class="s-facebook" target="_blank"
                                       href="{{ \App\Setting::FACEBOOK_SHARE_URL.env('FACEBOOK_APP_ID').'&href='.
                                       urlencode(route('page.lesson', $lesson->slug)).
                                       '&display=page&redirect_uri='.urlencode(route('page.lesson', $lesson->slug)) }}">Facebook</a>
                                </li>
                                <li><a class="s-whatsapp" target="_blank"
                                       href="{{ \App\Setting::WHATSAPP_MOBILE_SHARE_URL }}{{ route('page.lesson', $lesson->slug) }}">WhatsApp</a>
                                </li>
                            @else
                                <li><a class="s-messenger" target="_blank" href="{{ \App\Setting::MESSENGER_BASE_URL.env('FACEBOOK_APP_ID')
                .'&link='.route('page.lesson', $lesson->slug).'&redirect_uri='.route('page.lesson', $lesson->slug) }}">Messenger</a>
                                </li>
                                <li><a class="s-facebook" target="_blank"
                                       href="{{ \App\Setting::FACEBOOK_SHARE_URL.env('FACEBOOK_APP_ID').'&href='.
                                       urlencode(route('page.lesson', $lesson->slug)).
                                ...
                                <li><a class="s-whatsapp" target="_blank"
                                       href="{{ \App\Setting::WHATSAPP_SHARE_URL }}{{ route('page.lesson', $lesson->slug) }}">WhatsApp</a>
                                </li>
                            @endif
                        </ul>
                    </div>
