                ...
                <div class="modal-body" style="padding: 0px 45px 25px 45px">
                    <div class="row"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h3 style="text-align: left; font-weight: normal; color: #FFF!important">ID Upload</h3>
                            <h5 class=""
                                style="font-family:Open Sans, Arial, sans-serif; font-weight: 300; font-size: 19px;color: #FFF!important;">
                                Please note Stripe require scans of both front and back of ID Documents.
                    ...
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('post.stripe.upload.documents') }}" method="post"
